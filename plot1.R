...
png(file = "figure/plot1.png", width = 480, height = 480, res = 72)

# Plot the histogram
fontsize <- 1.0
hist(dataset$Global_active_power, main = "Global Active Power", xlab = "Global Active Power (kilowatts)", ylab = "Frequency", col = "red", cex = fontsize, cex.axis = fontsize, cex.lab = fontsize, cex.main = fontsize, cex.sub = fontsize)
